...
public class IpRangePolicyQueryController {
  ...
  //관리자 회사 전체 IP 정책 목록
  @GetMapping
  public List<IpRangePolicyResponse> getAll(@RequestParam Long comId) {
    return queryService.getAll(comId);
  }

  //관리자 활성 IP 정책 목록
  @GetMapping("/active")
  public List<IpRangePolicyResponse> getActive(@RequestParam Long comId) {
    return queryService.getActive(comId);
  }

  //관리자 출퇴근용 IP 정책 목록
  @GetMapping("/attendance")
  public List<IpRangePolicyResponse> getAttendance(@RequestParam Long comId) {
