...
-- 7) leave_grant (연차 지급 정보)
-- 모든 직원에게 2024, 2025, 2026년 연차 지급
INSERT INTO leave_grant
(grant_id, emp_id, year, total_days, remaining_days, granted_days, expire_date, is_deleted, created_at, created_by)
VALUES
    -- 2024년 연차 (거의 소진)
    (1,  1001, 2024, 15, 2.0,  '2024-01-01', '2024-12-31', 'N', NOW(6), 1),
    (2,  1002, 2024, 15, 1.5,  '2024-01-01', '2024-12-31', 'N', NOW(6), 1),
    (3,  1003, 2024, 15, 0.5,  '2024-01-01', '2024-12-31', 'N', NOW(6), 1),
    (4,  1004, 2024, 15, 3.0,  '2024-01-01', '2024-12-31', 'N', NOW(6), 1),
    (5,  1005, 2024, 15, 1.0,  '2024-01-01', '2024-12-31', 'N', NOW(6), 1),
    (6,  1006, 2024, 15, 2.5,  '2024-01-01', '2024-12-31', 'N', NOW(6), 1),
    (7,  1007, 2024, 15, 0.0,  '2024-01-01', '2024-12-31', 'N', NOW(6), 1),
    (8,  1008, 2024, 15, 4.0,  '2024-01-01', '2024-12-31', 'N', NOW(6), 1),
    (9,  1009, 2024, 15, 1.5,  '2024-01-01', '2024-12-31', 'N', NOW(6), 1),
    (10, 1010, 2024, 15, 2.0,  '2024-01-01', '2024-12-31', 'N', NOW(6), 1),
    (11, 1011, 2024, 15, 0.5,  '2024-01-01', '2024-12-31', 'N', NOW(6), 1),
    (12, 1012, 2024, 15, 3.5,  '2024-01-01', '2024-12-31', 'N', NOW(6), 1),
    (13, 1013, 2024, 15, 1.0,  '2024-01-01', '2024-12-31', 'N', NOW(6), 1),
    (14, 1014, 2024, 15, 2.5,  '2024-01-01', '2024-12-31', 'N', NOW(6), 1),
    (15, 1015, 2024, 15, 0.0,  '2024-01-01', '2024-12-31', 'N', NOW(6), 1),
    (16, 1016, 2024, 15, 4.5,  '2024-01-01', '2024-12-31', 'N', NOW(6), 1),
    (17, 1017, 2024, 15, 1.5,  '2024-01-01', '2024-12-31', 'N', NOW(6), 1),
    (18, 1018, 2024, 15, 3.0,  '2024-01-01', '2024-12-31', 'N', NOW(6), 1),
    (19, 1019, 2024, 15, 0.5,  '2024-01-01', '2024-12-31', 'N', NOW(6), 1),
    (20, 1020, 2024, 15, 2.0,  '2024-01-01', '2024-12-31', 'N', NOW(6), 1),

    -- 2025년 연차 (일부 사용)
    (21, 1001, 2025, 15, 10.5, '2025-01-01', '2025-12-31', 'N', NOW(6), 1),
    (22, 1002, 2025, 15, 12.0, '2025-01-01', '2025-12-31', 'N', NOW(6), 1),
    (23, 1003, 2025, 15, 9.5,  '2025-01-01', '2025-12-31', 'N', NOW(6), 1),
    (24, 1004, 2025, 15, 11.0, '2025-01-01', '2025-12-31', 'N', NOW(6), 1),
    (25, 1005, 2025, 15, 13.5, '2025-01-01', '2025-12-31', 'N', NOW(6), 1),
    (26, 1006, 2025, 15, 10.0, '2025-01-01', '2025-12-31', 'N', NOW(6), 1),
    (27, 1007, 2025, 15, 14.0, '2025-01-01', '2025-12-31', 'N', NOW(6), 1),
    (28, 1008, 2025, 15, 8.5,  '2025-01-01', '2025-12-31', 'N', NOW(6), 1),
    (29, 1009, 2025, 15, 12.5, '2025-01-01', '2025-12-31', 'N', NOW(6), 1),
    (30, 1010, 2025, 15, 11.0, '2025-01-01', '2025-12-31', 'N', NOW(6), 1),
    (31, 1011, 2025, 15, 9.0,  '2025-01-01', '2025-12-31', 'N', NOW(6), 1),
    (32, 1012, 2025, 15, 13.0, '2025-01-01', '2025-12-31', 'N', NOW(6), 1),
    (33, 1013, 2025, 15, 10.5, '2025-01-01', '2025-12-31', 'N', NOW(6), 1),
    (34, 1014, 2025, 15, 12.0, '2025-01-01', '2025-12-31', 'N', NOW(6), 1),
    (35, 1015, 2025, 15, 14.5, '2025-01-01', '2025-12-31', 'N', NOW(6), 1),
    (36, 1016, 2025, 15, 11.5, '2025-01-01', '2025-12-31', 'N', NOW(6), 1),
    (37, 1017, 2025, 15, 9.5,  '2025-01-01', '2025-12-31', 'N', NOW(6), 1),
    (38, 1018, 2025, 15, 13.5, '2025-01-01', '2025-12-31', 'N', NOW(6), 1),
    (39, 1019, 2025, 15, 10.0, '2025-01-01', '2025-12-31', 'N', NOW(6), 1),
    (40, 1020, 2025, 15, 12.5, '2025-01-01', '2025-12-31', 'N', NOW(6), 1),

    -- 2026년 연차 (거의 미사용)
    (41, 1001, 2026, 15, 15.0, '2026-01-01', '2026-12-31', 'N', NOW(6), 1),
    (42, 1002, 2026, 15, 15.0, '2026-01-01', '2026-12-31', 'N', NOW(6), 1),
    (43, 1003, 2026, 15, 15.0, '2026-01-01', '2026-12-31', 'N', NOW(6), 1),
    (44, 1004, 2026, 15, 15.0, '2026-01-01', '2026-12-31', 'N', NOW(6), 1),
    (45, 1005, 2026, 15, 15.0, '2026-01-01', '2026-12-31', 'N', NOW(6), 1),
    (46, 1006, 2026, 15, 15.0, '2026-01-01', '2026-12-31', 'N', NOW(6), 1),
    (47, 1007, 2026, 15, 15.0, '2026-01-01', '2026-12-31', 'N', NOW(6), 1),
    (48, 1008, 2026, 15, 15.0, '2026-01-01', '2026-12-31', 'N', NOW(6), 1),
    (49, 1009, 2026, 15, 15.0, '2026-01-01', '2026-12-31', 'N', NOW(6), 1),
    (50, 1010, 2026, 15, 15.0, '2026-01-01', '2026-12-31', 'N', NOW(6), 1),
    (51, 1011, 2026, 15, 15.0, '2026-01-01', '2026-12-31', 'N', NOW(6), 1),
    (52, 1012, 2026, 15, 15.0, '2026-01-01', '2026-12-31', 'N', NOW(6), 1),
    (53, 1013, 2026, 15, 15.0, '2026-01-01', '2026-12-31', 'N', NOW(6), 1),
    (54, 1014, 2026, 15, 15.0, '2026-01-01', '2026-12-31', 'N', NOW(6), 1),
    (55, 1015, 2026, 15, 15.0, '2026-01-01', '2026-12-31', 'N', NOW(6), 1),
    (56, 1016, 2026, 15, 15.0, '2026-01-01', '2026-12-31', 'N', NOW(6), 1),
    (57, 1017, 2026, 15, 15.0, '2026-01-01', '2026-12-31', 'N', NOW(6), 1),
